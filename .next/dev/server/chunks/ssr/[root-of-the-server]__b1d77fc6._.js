...
"[project]/Desktop/coiffeur/oop/infrastructure/data:07d0e1 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$07d0e1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/Desktop/coiffeur/oop/infrastructure/data:07d0e1 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
    ...
    const onSubmit = async (data)=>{
        startTransition(async ()=>{
            try {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$07d0e1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["rescheduleAppointment"])(appointmentId, data);
                if (result) {
...
function ApptCardInfo({ salonId, appointmentId, title, stylist, date, meta, status, stylistId, salonName, serviceDuration }) {
    ...
    const handleCancel = ()=>{
        ...
        startTransition(async ()=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$45d10e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["CancelAppointment"])(appointmentId, salonId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b1d77fc6._.js.map