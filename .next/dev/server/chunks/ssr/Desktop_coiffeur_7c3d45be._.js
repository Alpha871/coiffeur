...
(()=>{
    const e = new Error("Cannot find module '@/oop/infrastructure/service-action'");
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            ...
            if (type === "edit") {
                ...
                const newVal = await editService(defaultValues.id, vals.title || undefined, vals.category || undefined, vals.durationMin || undefined, vals.price || undefined, vals.description || undefined, vals.image || undefined);
            ...
            const newService = await addService(salonId, values.title, values.category, values.durationMin, values.price, values.description, values.image);
            const addedService = {
                id: newService.id,
...
function ManageServicesClient({ services }) {
    ...
    async function deleteService(s) {
        ...
        setIsDeleting(true);
        try {
            const deletedService = await deleteServiceById(s.id);
...
//# sourceMappingURL=Desktop_coiffeur_7c3d45be._.js.map