...
(()=>{
    const e = new Error("Cannot find module '@/oop/infrastructure/appointment-actions'");
    ...
    async function onSubmit(values) {
        try {
            ...
            if (type === "edit" && defaultAppointment) {
                ...
                try {
                    const result = await updateBookedAppointment(defaultAppointment?.id, changes, salonId);
                    if (result.success) {
        ...
        try {
            switch(status){
                case __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppointmentStatus"].CANCELLED:
                    await CancelAppointment(defaultAppointment.id, salonId);
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppointmentStatus"].APPROVED:
                    await ApproveAppointment(defaultAppointment.id, salonId);
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppointmentStatus"].REJECTED:
                    await RejectAppointment(defaultAppointment.id, salonId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a8af154a._.js.map