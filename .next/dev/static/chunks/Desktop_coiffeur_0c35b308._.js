...
"[project]/Desktop/coiffeur/app/(salon)/book-appointment/[id]/_components/book-appointment-client.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BookAppointmentClient({ salonServices, salonStaff }) {
    ...
    const selectedService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookAppointmentClient.useMemo[selectedService]": ()=>salonServices.find({
                "BookAppointmentClient.useMemo[selectedService]": (s)=>s.id === selectedServiceId
            }["BookAppointmentClient.useMemo[selectedService]"])
    }["BookAppointmentClient.useMemo[selectedService]"], [
        selectedServiceId,
        salonServices
    ]);
    const selectedStaff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookAppointmentClient.useMemo[selectedStaff]": ()=>salonStaff.find({
                "BookAppointmentClient.useMemo[selectedStaff]": (st)=>st.id === selectedStaffId
            }["BookAppointmentClient.useMemo[selectedStaff]"])
    }["BookAppointmentClient.useMemo[selectedStaff]"], [
        selectedStaffId,
        salonStaff
    ]);
    ...
    const filteredServices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookAppointmentClient.useMemo[filteredServices]": ()=>{
            const q = serviceQuery.trim().toLowerCase();
            if (!q) return salonServices;
            return salonServices.filter({
                "BookAppointmentClient.useMemo[filteredServices]": (s)=>s.label.toLowerCase().includes(q) || s.group.toLowerCase().includes(q)
            }["BookAppointmentClient.useMemo[filteredServices]"]);
        }
    }["BookAppointmentClient.useMemo[filteredServices]"], [
        serviceQuery,
    ...
    const filteredStaff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookAppointmentClient.useMemo[filteredStaff]": ()=>{
            const q = staffQuery.trim().toLowerCase();
            const salonStaffs = salonStaff.filter({
                "BookAppointmentClient.useMemo[filteredStaff].salonStaffs": (st)=>st.specialties.find({
                        "BookAppointmentClient.useMemo[filteredStaff].salonStaffs": (s)=>s.id === selectedServiceId
                    }["BookAppointmentClient.useMemo[filteredStaff].salonStaffs"])
            }["BookAppointmentClient.useMemo[filteredStaff].salonStaffs"]);
            if (!q) return salonStaffs;
            return salonStaffs?.filter({
                "BookAppointmentClient.useMemo[filteredStaff]": (st)=>st.name.toLowerCase().includes(q) || st.role.toLowerCase().includes(q)
            }["BookAppointmentClient.useMemo[filteredStaff]"]);
        }
    }["BookAppointmentClient.useMemo[filteredStaff]"], [
        staffQuery,
    ...
    const filteredStaffAvailabilities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookAppointmentClient.useMemo[filteredStaffAvailabilities]": ()=>{
            return filteredStaff.map({
                "BookAppointmentClient.useMemo[filteredStaffAvailabilities]": (st)=>st.availabilities.map({
                        "BookAppointmentClient.useMemo[filteredStaffAvailabilities]": (av)=>({
            ...
            }["BookAppointmentClient.useMemo[filteredStaffAvailabilities]"]).flat();
        }
    }["BookAppointmentClient.useMemo[filteredStaffAvailabilities]"], [
        filteredStaff
    ]);
    const timeSlotsForSelectedDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookAppointmentClient.useMemo[timeSlotsForSelectedDate]": ()=>{
            ...
            const filteredAppointmentsForDay = filteredStaff.map({
                "BookAppointmentClient.useMemo[timeSlotsForSelectedDate].filteredAppointmentsForDay": (st)=>st.appointments.filter({
                        "BookAppointmentClient.useMemo[timeSlotsForSelectedDate].filteredAppointmentsForDay": (appointment)=>appointment.startsAt.getDay() + 1 === selectedDate.getDay() + 1 && appointment.startsAt.getFullYear() === selectedDate.getFullYear() && appointment.startsAt.getMonth() === selectedDate.getMonth()
                    }["BookAppointmentClient.useMemo[timeSlotsForSelectedDate].filteredAppointmentsForDay"])
            }["BookAppointmentClient.useMemo[timeSlotsForSelectedDate].filteredAppointmentsForDay"]).flat().map({
                "BookAppointmentClient.useMemo[timeSlotsForSelectedDate].filteredAppointmentsForDay": (appointment)=>({
            ...
            const hasConflictingAppointment = {
                "BookAppointmentClient.useMemo[timeSlotsForSelectedDate].hasConflictingAppointment": (startAt, endAt)=>{
                    return filteredAppointmentsForDay.some({
                        "BookAppointmentClient.useMemo[timeSlotsForSelectedDate].hasConflictingAppointment": (appointment)=>{
                    ...
                    }["BookAppointmentClient.useMemo[timeSlotsForSelectedDate].hasConflictingAppointment"]);
                }
            }["BookAppointmentClient.useMemo[timeSlotsForSelectedDate].hasConflictingAppointment"];
            const availabilitiesForDay = filteredStaffAvailabilities.filter({
                "BookAppointmentClient.useMemo[timeSlotsForSelectedDate].availabilitiesForDay": (av)=>av.dayOfWeek === dayOfWeek && !av.closed
            }["BookAppointmentClient.useMemo[timeSlotsForSelectedDate].availabilitiesForDay"]);
            if (availabilitiesForDay.length === 0) return [];
            const slots = [];
            availabilitiesForDay.forEach({
                "BookAppointmentClient.useMemo[timeSlotsForSelectedDate]": (av)=>{
...
_s(BookAppointmentClient, "re2GeT0wH91yKoZK+n06iR6VzF4=", false, function() {
    return [
...
_c = BookAppointmentClient;
var _c;
__turbopack_context__.k.register(_c, "BookAppointmentClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_coiffeur_0c35b308._.js.map