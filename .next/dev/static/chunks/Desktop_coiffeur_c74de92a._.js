...
"[project]/Desktop/coiffeur/oop/infrastructure/data:118c7d [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$118c7d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/Desktop/coiffeur/oop/infrastructure/data:118c7d [app-client] (ecmascript) <text/javascript>");
...
function CreateSalonForm() {
    ...
    async function onSubmit(values) {
        ...
        try {
            const salonData = new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$domain$2f$salon$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Salon"](values.salonName, values.address, values.phone, values.email, values.description || "", openingHours);
            if (!salonData.isComplete()) {
                throw new Error("Please fill in all required fields correctly.");
            }
            const { success, message } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$118c7d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["requestSalon"])(salonData.toJSON());
            if (!success) {
                throw new Error(message);
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(message);
            form.reset();
            router.push("/salon/request-salon-management");
        } catch (error) {
...
_s(CreateSalonForm, "m7NOZYzFUPCFp8F6TeTZXtBO/+I=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_coiffeur_c74de92a._.js.map