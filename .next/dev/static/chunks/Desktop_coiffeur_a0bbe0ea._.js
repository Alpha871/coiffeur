        ...
        "AppointmentClient.useMemo[members]": ()=>{
            ...
            return uniqueMembers.map({
                "AppointmentClient.useMemo[members]": (member)=>({
                        ...member,
                        color: `hsl(${Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomValues"])())}, 70%, 50%)`
                    })
            }["AppointmentClient.useMemo[members]"]);
        }
    }["AppointmentClient.useMemo[members]"], [
        ...
        "AppointmentClient.useEffect": ()=>{
            ...
            if (searchQuery) {
                ...
                filteredAppointments = filteredAppointments.filter({
                    "AppointmentClient.useEffect": (apt)=>apt.customerName.toLowerCase().includes(query) || apt.service.toLowerCase().includes(query) || apt.memberName.toLowerCase().includes(query)
                }["AppointmentClient.useEffect"]);
            }
...
_s(AppointmentClient, "BAcOJMI1YOI9fwbACjpLqCrk/RM=");
...
//# sourceMappingURL=Desktop_coiffeur_a0bbe0ea._.js.map