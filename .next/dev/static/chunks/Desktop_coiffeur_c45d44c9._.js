...
"[project]/Desktop/coiffeur/oop/infrastructure/data:8aea32 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
    ...
    const onSubmit = async (data)=>{
        startTransition(async ()=>{
            try {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$8aea32__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["rescheduleAppointment"])(appointmentId, data);
                if (result) {
...
function ApptCardInfo({ salonId, appointmentId, title, stylist, date, meta, status, stylistId, salonName, serviceDuration }) {
    ...
    const handleCancel = ()=>{
        ...
        startTransition(async ()=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$4fbffe__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["CancelAppointment"])(appointmentId, salonId);
...
//# sourceMappingURL=Desktop_coiffeur_c45d44c9._.js.map