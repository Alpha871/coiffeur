...
"[project]/Desktop/coiffeur/oop/infrastructure/data:c7a489 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$c7a489__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/Desktop/coiffeur/oop/infrastructure/data:c7a489 [app-client] (ecmascript) <text/javascript>");
...
function CreateInviteButton({ type = "default", setPendingInvites, setActiveId }) {
    ...
    async function handleCreateInvite(data) {
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$c7a489__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendInvitation"])(data.email, data.role, id, activeOrganization?.id);
            if (!result) {
...
"[project]/Desktop/coiffeur/oop/infrastructure/data:d66f5a [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/coiffeur/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$d66f5a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/Desktop/coiffeur/oop/infrastructure/data:d66f5a [app-client] (ecmascript) <text/javascript>");
...
salonServices }) {
    ...
    async function handleSaveInfo(values) {
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$eb3cf1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserInfo"])(active.user.id, salonId, changes);
            if (!result) return;
    ...
    async function handleSaveSpecialties(values) {
        if (!active) return;
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$oop$2f$infrastructure$2f$data$3a$d66f5a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["assignMemberSpecialties"])(active.id, salonId, values.skills);
            // setStaff((prev) =>
            //   prev.map((s) =>
            //     s.id === active.id
            //       ? {
...
//# sourceMappingURL=Desktop_coiffeur_94540f12._.js.map