...
function NewAppointmentPage() {
    ...
    const selectedService = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "NewAppointmentPage.useMemo[selectedService]": ()=>SERVICES.find({
                "NewAppointmentPage.useMemo[selectedService]": (s)=>s.id === selectedServiceId
            }["NewAppointmentPage.useMemo[selectedService]"])
    }["NewAppointmentPage.useMemo[selectedService]"], [
        selectedServiceId
    ]);
    const selectedStaff = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$coiffeur$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "NewAppointmentPage.useMemo[selectedStaff]": ()=>STAFF.find({
                "NewAppointmentPage.useMemo[selectedStaff]": (st)=>st.id === selectedStaffId
            }["NewAppointmentPage.useMemo[selectedStaff]"])
    }["NewAppointmentPage.useMemo[selectedStaff]"], [
        selectedStaffId
    ]);
...
_s(NewAppointmentPage, "S4hKt/f4niib48rhB0Z2DnOxewM=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_coiffeur_2a3afaa5._.js.map